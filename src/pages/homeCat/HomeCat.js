                  ...
                  <Form.Row>
                    <Form.Group as={Row}>
                      <Col>
                        ...
                        />
                        <span className="space"> </span> <Link to="/terms" ><span className="space">Acceptar Condicions</span></Link> <span className="space">i</span> <Link to="/policy"  className="space">Política de privacitat</Link>
                        </div>
                      </Col>
                    </Form.Group>
                  </Form.Row>
